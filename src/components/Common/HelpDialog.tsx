...
const STATIC_GROUPS: { title: string; items: StaticEntry[] }[] = [
  {
    ...
    items: [
      ...
      { keys: ['空白をドラッグ'], label: '時間範囲に重なるクリップをまとめて選択' },
      { keys: ['Shift', '空白をドラッグ'], label: '時間範囲のクリップを選択へ追加' },
      { keys: ['選択クリップをドラッグ'], label: '複数クリップの間隔を保ってまとめて移動' },
      { keys: ['端をドラッグ'], label: 'クリップの開始・終了をトリミング' },
      { keys: ['Shift', 'ドラッグ'], label: 'スナップを一時的に無効化' },
      { keys: ['Esc'], label: 'ドラッグを取り消す / 選択を解除' },
      { keys: ['Alt', '← / →'], label: '選択クリップを0.1秒ずつ移動' },
      { keys: ['Shift', 'Alt', '← / →'], label: '選択クリップを1秒ずつ移動' },
      { keys: ['Ctrl', 'C'], label: '選択クリップをコピー' },
      { keys: ['Ctrl', 'V'], label: '再生位置へ貼り付け' },
      { keys: ['Ctrl', 'D'], label: '選択クリップを複製' },
      { keys: ['Ctrl', 'A'], label: 'すべてのクリップを選択' },
